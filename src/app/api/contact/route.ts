...
export async function POST(req: NextRequest) {
  try {
      ...
      html: `
       <div style="font-family: 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0, 0, 0, 0.05); overflow: hidden;">
        <div style="background-color: #4A90E2; padding: 25px 30px; text-align: center; color: #ffffff;">
            <h1 style="margin: 0; font-size: 28px; font-weight: bold;">Customer Contact Request</h1>
        </div>
        <div style="padding: 30px;">
            <p style="font-size: 16px; color: #333333; line-height: 1.6;">You've received a new message from your website contact form. Here are the details:</p>
    ...
    return NextResponse.json({ message: 'We have received your message! We will contact you shortly.' });
  } catch (err) {
